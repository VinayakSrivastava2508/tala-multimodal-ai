...
EXACT_FILENAME_SCHEMA: Dict[str, str] = {
    ...
    "rag_collection_summary":          "rag_collection_summary",
    "rag_corpus_coverage":              "rag_corpus_coverage",
    "rag_modality_coverage":            "rag_modality_coverage",
    "rag_retrieval_evaluation":        "rag_retrieval_evaluation",
    "rag_query_routing_evaluation":    "rag_query_routing_evaluation",
    "rag_citation_validation":          "rag_citation_validation",
    "rag_latency_summary":              "rag_latency_summary",
    "rag_demo_cases":                    "rag_demo_cases",
    "rag_go_no_go":                      "rag_go_no_go",
    # Day 3C: executive analytical synthesis + creator-strategy comparison
    "analytical_synthesis_claim_master":  "analytical_synthesis_claim_master",
    "claim_label_summary":                "claim_label_summary",
    "mixed_claim_deep_dive":              "mixed_claim_deep_dive",
    "mixed_claim_theme_summary":          "mixed_claim_theme_summary",
    "aligned_claim_examples":              "aligned_claim_examples",
    "insufficient_evidence_analysis":    "insufficient_evidence_analysis",
    "modality_contribution_summary":      "modality_contribution_summary",
    "evidence_gap_by_category":            "evidence_gap_by_category",
    "creator_strategy_evidence_coverage": "creator_strategy_evidence_coverage",
    "creator_partnership_mix":            "creator_partnership_mix",
    "creator_content_intent_mix":          "creator_content_intent_mix",
    "creator_partnership_intent_matrix":  "creator_partnership_intent_matrix",
    "brand_platform_strategy_comparison": "brand_platform_strategy_comparison",
    "creator_strategic_pattern_metrics":  "creator_strategic_pattern_metrics",
    "creator_strategy_interpretation":    "creator_strategy_interpretation",
    "tala_competitor_lessons":              "tala_competitor_lessons",
